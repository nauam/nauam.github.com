    ...
    children: [
        ['/en/user-guide/projects', 'Projects'],
        {
            ...
            children: [
                ...
                //     ]
                // },
                // '/en/user-guide/-plugins',
                // '/en/user-guide/execution-lifecycle/-resume.md',
                // '/en/user-guide/execution-lifecycle/-retry-failed-nodes.md',
                // '/en/user-guide/execution-lifecycle/-data.md',
                // '/en/user-guide/s/-queue.md',
            ]
        },
        // {
        //     title: 'Nodes',
        ...
        //         '/en/user-guide/schedules/missedfires.md'
        //     ],
        //     sidebarDepth: 1
        // },
        // {
        ...
        //             sidebarDepth: 2,
        //             children: [
        //                 '/en/user-guide/webhooks/advanced-run-',
        //                 '/en/user-guide/webhooks/pagerduty-run-',
        //                 '/en/user-guide/webhooks/datadog-run-.md',
        //                 '/en/user-guide/webhooks/aws-sns-webhook',
        //                 '/en/user-guide/webhooks/github-webhook',
        //                 '/en/user-guide/webhooks/run-.md',
        ...
        //         '/en/user-guide/document-format-reference/-v20.md',
        //         '/en/user-guide/document-format-reference/-yaml-v12.md',
