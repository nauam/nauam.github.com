    ...
    children: [
        ['/user-guide/projects', 'Projetos'],
        {
            ...
            children: [
                ...
                // },
                // '/user-guide/-plugins',
                // '/user-guide/execution-lifecycle/-resume.md',
                // '/user-guide/execution-lifecycle/-retry-failed-nodes.md',
                // '/user-guide/execution-lifecycle/-data.md',
                // '/user-guide/s/-queue.md',
            ]
        },
        // {
        //     title: 'Nós',
        ...
        //         '/user-guide/schedules/missedfires.md'
        //     ],
        //     sidebarDepth: 1
        // },
        // {
        ...
        //             sidebarDepth: 2,
        //             children: [
        //                 '/user-guide/webhooks/advanced-run-',
        //                 '/user-guide/webhooks/pagerduty-run-',
        //                 '/user-guide/webhooks/datadog-run-.md',
        //                 '/user-guide/webhooks/aws-sns-webhook',
        //                 '/user-guide/webhooks/github-webhook',
        //                 '/user-guide/webhooks/run-.md',
        ...
        //         '/user-guide/document-format-reference/-v20.md',
        //         '/user-guide/document-format-reference/-yaml-v12.md',
